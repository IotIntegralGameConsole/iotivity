...
#
#  More at:
#  https://jira.iotivity.org/browse/IOT-820
#
EOF
    ...
    if [ ! -e 'extlibs/tinycbor/tinycbor' ] ; then
        do_ "git clone -b "${tinycbor_rev}" "$tinycbor_url" extlibs/tinycbor/tinycbor"
    fi
