...
void StartEasySetup()
{
    ...
    //ESInitEnrollee with sercurity mode disabled for esp8266
...
void setup()
{
    ...
    // Note : This will initialize Serial port on esp8266 at 115200 bauds
    OIC_LOG_INIT();
...
void loop()
{
    ...
    // of ESP8266 microcontroller. Modify it as per specific application needs.
    delay(500);
}
